	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Events': [
			{
				...
				map_image_url: 'img/thumb_map_event_1.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Museum free entrance',
				description_point: 'Piazza del Duomo 1, Florence',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_detail: 'florence-event-detail.html'
			},
			{
				type_point: 'Historic Buildings',
				location_latitude: 43.775815, 
				location_longitude: 11.248637,
				map_image_url: 'img/thumb_map_event_2.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Flea Market',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_event_3.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Lantern Festival',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_event_4.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Duomo free entrance',
				description_point: 'Piazza di S. Maria Novella, Florence',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_detail: 'florence-event-detail.html'
			},
			{
				...
				map_image_url: 'img/thumb_map_event_5.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Brunelleschi',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_event_6.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Exhibition',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_event_7.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Football Match',
			...
			},
			{
				...
				location_latitude: 43.769560, 
				location_longitude: 11.255814,
				map_image_url: 'img/thumb_map_event_8.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Florence by night',
				description_point: 'Palazzo Strozzi 9, Florence',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_detail: 'florence-event-detail.html'
